...
export class ExpensesController {
    async create(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const expense = await expensesService.create(req.user!.tenantId!, req.body, req.user!.employeeId);
    ...
    async update(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const expense = await expensesService.update(req.params.id, req.user!.tenantId!, req.body);
