...
export class BookkeepingController {
  ...
  dashboard = async (req: Request, res: Response, next: NextFunction) => { try { sendSuccess(res, await bookkeepingService.dashboard(tenant(req))); } catch (error) { next(error); } };
  ...
  deleteVendor = async (req: Request, res: Response, next: NextFunction) => { try { await bookkeepingService.deleteVendor(req.params.id, tenant(req)); sendNoContent(res); } catch (error) { next(error); } };
  ...
  updateReconciliation = async (req: Request, res: Response, next: NextFunction) => { try { sendSuccess(res, await bookkeepingService.updateReconciliation(req.params.id, tenant(req), sanitizeBody(req.body)), 'Reconciliation updated'); } catch (error) { next(error); } };
  ...
  updateRecurringRule = async (req: Request, res: Response, next: NextFunction) => { try { sendSuccess(res, await bookkeepingService.updateRecurringRule(req.params.id, tenant(req), sanitizeBody(req.body)), 'Recurring rule updated'); } catch (error) { next(error); } };
  deleteRecurringRule = async (req: Request, res: Response, next: NextFunction) => { try { await bookkeepingService.deleteRecurringRule(req.params.id, tenant(req)); sendNoContent(res); } catch (error) { next(error); } };
