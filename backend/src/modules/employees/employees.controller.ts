...
export class EmployeesController {
    async create(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const emp = await employeesService.create(req.user!.tenantId!, sanitizeBody(req.body));
    ...
    async update(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const emp = await employeesService.update(req.params.id, req.user!.tenantId!, sanitizeBody(req.body));
