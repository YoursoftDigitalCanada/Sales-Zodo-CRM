...
export class FoldersController {
    ...
    async getMany(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const result = await foldersService.getMany(req.user!.tenantId!, req.query as any);
    ...
    async getById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const folder = await foldersService.getById(req.params.id, req.user!.tenantId!);
    ...
    async delete(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            await foldersService.delete(req.params.id, req.user!.tenantId!);
            sendNoContent(res);
        } catch (e) { next(e); }
    }
}
