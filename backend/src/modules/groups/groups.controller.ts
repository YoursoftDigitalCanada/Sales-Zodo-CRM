...
export class GroupsController {
    ...
    async getMany(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const result = await groupsService.getMany(req.user!.tenantId!, req.query as any);
    ...
    async getById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const group = await groupsService.getById(req.params.id, req.user!.tenantId!);
    ...
    async addMembers(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            await groupsService.addMembers(req.params.id, req.user!.tenantId!, req.body.clientIds);
    ...
    async removeMembers(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            await groupsService.removeMembers(req.params.id, req.user!.tenantId!, req.body.clientIds);
    ...
    async delete(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            await groupsService.delete(req.params.id, req.user!.tenantId!);
            sendNoContent(res);
        } catch (e) { next(e); }
    }
}
