  ...
  async create(tenantId: string, data: CreateProjectDto, createdById?: string) {
    ...
    return prisma.project.create({
      data: {
        ...
        currency: (data.currency as any) ?? 'CAD',
        ...
        organization: data.organization ?? data.name ?? null,
        organizationName: data.organizationName ?? data.organization ?? data.name ?? null,
        nextStep: data.nextStep ?? null,
        dealStatus: data.dealStatus ?? 'Qualification',
        dealOwnerId: data.dealOwnerId ?? data.salesRepId ?? data.projectManagerId ?? null,
        probability: this.asDecimalOrNull(data.probability),
        expectedDealValue: this.asDecimalOrNull(data.expectedDealValue ?? data.budget ?? data.contractValue),
        dealValue: this.asDecimalOrNull(data.dealValue ?? data.contractValue ?? data.budget),
        expectedClosureDate: this.asDateOrNull(data.expectedClosureDate ?? data.estimatedEndDate),
        closedDate: this.asDateOrNull(data.closedDate),
        ...
        exchangeRate: this.asDecimalOrNull(data.exchangeRate ?? 1),
        annualRevenue: this.asDecimalOrNull(data.annualRevenue),
        ...
        total: this.asDecimalOrNull(data.total ?? data.dealValue ?? data.contractValue),
        netTotal: this.asDecimalOrNull(data.netTotal ?? data.dealValue ?? data.contractValue),
  ...
  async update(id: string, tenantId: string, data: UpdateProjectDto) {
    ...
    return prisma.project.update({
      ...
      data: {
        ...
        ...(data.dealStatus !== undefined && { dealStatus: data.dealStatus }),
        ...(data.dealOwnerId !== undefined && { dealOwnerId: data.dealOwnerId }),
        ...(data.probability !== undefined && { probability: this.asDecimalOrNull(data.probability) }),
        ...(data.expectedDealValue !== undefined && { expectedDealValue: this.asDecimalOrNull(data.expectedDealValue) }),
        ...(data.dealValue !== undefined && { dealValue: this.asDecimalOrNull(data.dealValue) }),
        ...(data.expectedClosureDate !== undefined && { expectedClosureDate: this.asDateOrNull(data.expectedClosureDate) }),
        ...(data.closedDate !== undefined && { closedDate: this.asDateOrNull(data.closedDate) }),
        ...
        ...(data.exchangeRate !== undefined && { exchangeRate: this.asDecimalOrNull(data.exchangeRate) }),
        ...(data.annualRevenue !== undefined && { annualRevenue: this.asDecimalOrNull(data.annualRevenue) }),
        ...
        ...(data.total !== undefined && { total: this.asDecimalOrNull(data.total) }),
        ...(data.netTotal !== undefined && { netTotal: this.asDecimalOrNull(data.netTotal) }),
        ...(data.lostReason !== undefined && { lostReason: data.lostReason }),
        ...(data.lostNotes !== undefined && { lostNotes: data.lostNotes }),
