...
router.get('/', requirePermission(PERMISSIONS.QUOTES_VIEW), validate(quoteQuerySchema), quotesController.getMany.bind(quotesController));
router.post('/', requirePermission(PERMISSIONS.QUOTES_CREATE), validate(createQuoteSchema), quotesController.create.bind(quotesController));
router.get('/:id', requirePermission(PERMISSIONS.QUOTES_VIEW), quotesController.getById.bind(quotesController));
router.put('/:id', requirePermission(PERMISSIONS.QUOTES_UPDATE), validate(updateQuoteSchema), quotesController.update.bind(quotesController));
