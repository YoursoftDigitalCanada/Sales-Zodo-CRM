...
const MANAGER_PERMISSIONS: string[] = [
    ...
    // Support
    PERMISSIONS.SUPPORT_VIEW, PERMISSIONS.SUPPORT_CREATE, PERMISSIONS.SUPPORT_UPDATE, PERMISSIONS.SUPPORT_DELETE,
    // Roof Estimator
    PERMISSIONS.ROOF_ESTIMATOR_VIEW, PERMISSIONS.ROOF_ESTIMATOR_CREATE, PERMISSIONS.ROOF_ESTIMATOR_UPDATE, PERMISSIONS.ROOF_ESTIMATOR_DELETE,
];
...
const STAFF_PERMISSIONS: string[] = [
    ...
    PERMISSIONS.ROOF_ESTIMATOR_VIEW, PERMISSIONS.ROOF_ESTIMATOR_CREATE, PERMISSIONS.ROOF_ESTIMATOR_UPDATE,
];
