...
router.get('/integrations', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.listIntegrations.bind(websiteAnalyticsController));
router.post('/integrations', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(bodySchema), websiteAnalyticsController.createIntegration.bind(websiteAnalyticsController));
router.get('/integrations/:id', requirePermission(PERMISSIONS.ANALYTICS_VIEW), validate(idSchema), websiteAnalyticsController.getIntegration.bind(websiteAnalyticsController));
router.put('/integrations/:id', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(idSchema), validate(bodySchema), websiteAnalyticsController.updateIntegration.bind(websiteAnalyticsController));
router.delete('/integrations/:id', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(idSchema), websiteAnalyticsController.deleteIntegration.bind(websiteAnalyticsController));
router.post('/integrations/:id/test', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(idSchema), websiteAnalyticsController.testIntegration.bind(websiteAnalyticsController));
router.get('/integrations/:id/deliveries', requirePermission(PERMISSIONS.ANALYTICS_VIEW), validate(idSchema), websiteAnalyticsController.listIntegrationDeliveries.bind(websiteAnalyticsController));
router.post('/privacy/export-visitor', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(bodySchema), websiteAnalyticsController.exportVisitor.bind(websiteAnalyticsController));
router.post('/privacy/delete-visitor', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(bodySchema), websiteAnalyticsController.deleteVisitor.bind(websiteAnalyticsController));
router.post('/privacy/delete-session/:sessionId', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(sessionIdSchema), websiteAnalyticsController.deleteSessionPrivacy.bind(websiteAnalyticsController));
router.post('/privacy/anonymize-session/:sessionId', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(sessionIdSchema), websiteAnalyticsController.anonymizeSession.bind(websiteAnalyticsController));
router.get('/privacy/retention-preview', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.retentionPreview.bind(websiteAnalyticsController));
router.post('/privacy/run-retention-cleanup', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(bodySchema), websiteAnalyticsController.runRetentionCleanup.bind(websiteAnalyticsController));
router.get('/reports/overview', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportOverview.bind(websiteAnalyticsController));
router.get('/reports/pages', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportPages.bind(websiteAnalyticsController));
router.get('/reports/acquisition', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportAcquisition.bind(websiteAnalyticsController));
router.get('/reports/behavior', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportBehavior.bind(websiteAnalyticsController));
router.get('/reports/technical', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportTechnical.bind(websiteAnalyticsController));
router.get('/reports/conversions', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.reportConversions.bind(websiteAnalyticsController));
router.get('/admin/storage-usage', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.storageUsage.bind(websiteAnalyticsController));
router.get('/admin/ingestion-health', requirePermission(PERMISSIONS.ANALYTICS_VIEW), websiteAnalyticsController.ingestionHealth.bind(websiteAnalyticsController));
router.post('/admin/reprocess-session/:sessionId', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(sessionIdSchema), websiteAnalyticsController.reprocessSession.bind(websiteAnalyticsController));
router.post('/admin/rebuild-heatmap/:snapshotId', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(z.object({ params: z.object({ snapshotId: z.string().uuid() }) }).passthrough()), websiteAnalyticsController.rebuildHeatmap.bind(websiteAnalyticsController));
router.post('/admin/recalculate-funnel/:runId', requirePermission(PERMISSIONS.ANALYTICS_EXPORT), validate(runIdSchema), websiteAnalyticsController.recalculateFunnel.bind(websiteAnalyticsController));
