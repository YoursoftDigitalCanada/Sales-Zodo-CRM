  ...
  const items = useMemo<PaletteAction[]>(
    () => [
      ...
      },
      {
        ...
        icon: Users,
        section: "Navigate",
        keywords: ["clients client list directory"],
      ...
      {
        id: "nav-estimator",
        label: "Go to AI Roof Estimator",
        icon: Zap,
        section: "Navigate",
        keywords: ["roof estimator ai eagleview"],
        action: () => navigate("/roof-estimator"),
      },
      {
        id: "action-create",
