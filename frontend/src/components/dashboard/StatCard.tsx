...
export function StatCard({
  ...
  return (
    <motion.div
      ...
      transition={{ delay }}
      whileHover={{ y: -4 }}
      className="relative bg-white rounded-2xl p-6 border border-slate-200 hover:border-[#23D3EE]/30 hover:shadow-xl hover:shadow-[#23D3EE]/5 transition-all overflow-hidden group"
    >
        ...
        {progress !== undefined && (
          <div className="mt-4">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-xs font-semibold text-[#23D3EE]">
                {progress}%
              </span>
            </div>
