      ...
      <div className="relative h-24 bg-gradient-to-r from-[#23D3EE] to-[#6366F1] p-5">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-14 h-14 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-xl border border-white/30">
              ZS
            </div>
            <div>
              <h2 className="text-xl font-bold text-white">Zylker Sales</h2>
              <p className="text-white/80 text-sm">Workspace Booking Page</p>
            </div>
          </div>
              ...
              pages.map((page, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-xs text-slate-400">{page.bookings || 0} bookings</span>
      ...
      <div className="flex items-start gap-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="p-2 rounded-lg hover:bg-slate-100 text-slate-400 opacity-0 group-hover:opacity-100 transition-all">
              <MoreVertical size={16} />
            </button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-48 rounded-xl">
            <DropdownMenuItem onClick={onOpenPage} className="rounded-lg">
              <ExternalLink size={14} className="mr-2" />
              Open Page
            </DropdownMenuItem>
            <DropdownMenuItem onClick={onShare} className="rounded-lg">
        ...
        <div className="p-6">
          <Tabs defaultValue="theme" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 rounded-xl bg-slate-100 p-1">
              <TabsTrigger value="theme" className="rounded-lg data-[state=active]:bg-white">
                <Palette size={16} className="mr-2" />
                Theme
              </TabsTrigger>
              <TabsTrigger value="layout" className="rounded-lg data-[state=active]:bg-white">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
            ...
            <div className={cn(
              "bg-slate-50 rounded-xl p-4 flex items-center justify-center",
      ...
      <DialogContent className="sm:max-w-[450px] p-0 rounded-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium text-slate-600">Page Link</Label>
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <Input
                  value={pageUrl}
                  readOnly
                  className="h-11 pl-10 pr-4 rounded-xl border-slate-200 bg-slate-50"
                />
              </div>
              <Button
                onClick={handleCopy}
          ...
          {/* Share Options */}
          <div className="space-y-2">
            <Label className="text-sm font-medium text-slate-600">Share via</Label>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] p-0 rounded-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Custom Slug */}
          <div className="space-y-2">
            <Label className="text-sm font-medium text-slate-600">Custom URL (optional)</Label>
            <div className="relative">
      ...
      >
        ...
        <div className="p-6 space-y-6">
                  ...
                  <AnimatePresence>
                    {users.length > 0 ? (
                      ...
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="text-center py-8 bg-white rounded-2xl border border-slate-200"
                      >
          ...
          >
            ...
            {/* Chart Area */}
            <div className="mt-6 h-[200px] bg-gradient-to-br from-slate-50 to-white rounded-xl border border-slate-100 flex items-center justify-center">
              <div className="text-center">
                <BarChart3 size={40} className="mx-auto text-slate-300 mb-2" />
                <p className="text-sm text-slate-400">Chart visualization</p>
                <p className="text-xs text-slate-300">Integrate with your preferred charting library</p>
              </div>
            </div>
