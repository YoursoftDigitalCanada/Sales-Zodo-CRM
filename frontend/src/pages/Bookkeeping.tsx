    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl rounded-2xl">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <Field label="Payment Method"><Input value={form.paymentMethod || ""} onChange={(e) => setForm({ ...form, paymentMethod: e.target.value })} placeholder="Card, EFT, cash" className="rounded-xl h-10 border-[rgba(15,23,42,0.06)] focus-visible:ring-[#0891B2]/20" /></Field>
