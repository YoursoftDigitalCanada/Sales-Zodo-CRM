...
const MODULE_COLORS: Record<string, string> = {
    ...
    task_pipeline: "#7C3AED", meetings: "#16A34A", calls: "#0891B2", payments: "#D97706",
    email_templates: "#D97706", sequences: "#7C3AED", reports: "#0891B2", forecast: "#16A34A",
    website_analytics: "#0891B2", sales_assistant: "#7C3AED", email_generator: "#D97706",
    lead_scoring: "#16A34A", deal_insights: "#7C3AED", subscriptions: "#D97706", pricing_plans: "#D97706",
};
...
const SALES_CRM_PERMISSION_ROWS: PermissionMatrixRow[] = [
    ...
    { id: "task-pipeline", label: "Task Pipeline", modules: ["task_pipeline"] },
    { id: "meetings", label: "Meetings", modules: ["meetings"] },
    { id: "calls", label: "Calls", modules: ["calls"] },
    { id: "sequences", label: "Sequences", modules: ["sequences"] },
    { id: "email-templates", label: "Email Templates", modules: ["email_templates"] },
    ...
    { id: "payments", label: "Payments", modules: ["payments"] },
    { id: "bookkeeping", label: "Bookkeeping", modules: ["bookkeeping"] },
    { id: "subscriptions", label: "Subscriptions", modules: ["subscriptions"] },
    { id: "pricing-plans", label: "Pricing Plans", modules: ["pricing_plans"] },
    ...
    { id: "sales-assistant", label: "Sales Assistant", modules: ["sales_assistant"] },
    { id: "email-generator", label: "Email Generator", modules: ["email_generator"] },
    { id: "lead-scoring", label: "Lead Scoring", modules: ["lead_scoring"] },
    { id: "deal-insights", label: "Deal Insights", modules: ["deal_insights"] },
    { id: "users", label: "Users", modules: ["users", "employees"] },
    { id: "roles", label: "Roles", modules: ["roles"] },
    { id: "reports", label: "Reports", modules: ["reports"] },
    { id: "forecast", label: "Forecast", modules: ["forecast"] },
    { id: "website-analytics", label: "Website Analytics", modules: ["website_analytics"] },
