...
export const CreateLeadSchema = z.object({
  ...
  leadType: z.enum(["Inbound", "Outbound"]).optional().nullable(),
  buyingIntent: z.enum(["Low", "Medium", "High"]).optional().nullable(),
  purchaseTimeline: z.string().max(100).optional().nullable(),
  productInterest: z.string().max(255).optional().nullable(),
  numberOfUsers: z.number().int().min(0).optional().nullable(),
  currentSolution: z.string().max(255).optional().nullable(),
  teamRegion: z.string().max(100).optional().nullable(),
