...
export const CreateProjectSchema = z
  .object({
    ...
    permitPulledDate: dateLike,
    permitApprovedDate: dateLike,
    internalNotes: z.string().optional().nullable(),
    organization: z.string().optional().nullable(),
    organizationName: z.string().optional().nullable(),
    nextStep: z.string().optional().nullable(),
    dealStatus: z.string().optional().nullable(),
    dealOwnerId: z.string().optional().nullable(),
    probability: z.number().min(0).max(100).optional().nullable(),
    expectedDealValue: z.number().min(0).optional().nullable(),
    dealValue: z.number().min(0).optional().nullable(),
    expectedClosureDate: dateLike,
    closedDate: dateLike,
    sourceId: z.string().optional().nullable(),
    leadName: z.string().optional().nullable(),
    website: z.string().optional().nullable(),
    noOfEmployees: z.string().optional().nullable(),
    ...
    netTotal: z.number().min(0).optional().nullable(),
